...
CREATE TABLE [OrderItem] (
    ...
    [DiscountAmount] decimal(16,3) NOT NULL,
    [TotalAmount] decimal(16,3) NOT NULL,
    [GoodsIssueOrderId] nvarchar(50) NULL,
    [PurchaseOrderId] nvarchar(50) NULL,
...
CREATE TABLE [GoodsReceiptOrderItems] (
    [Id] nvarchar(50) NOT NULL,
    [GoodsReceiptOrderId] nvarchar(50) NULL,
    [ProductVariantId] nvarchar(50) NULL,
...
CREATE TABLE [Package] (
    ...
    [SupplierId] nvarchar(50) NULL,
    [Price] decimal(16,3) NOT NULL,
    [TotalPrice] decimal(16,3) NOT NULL,
